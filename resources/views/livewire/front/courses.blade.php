        ...
        <div class="container">
            ...
            <form class="bg-light border p-4 rounded-3 my-4 z-index-9 position-relative">
                <div class="row g-3">
                    <!-- Input -->
                    <div class="col-xl-3">
                        <input class="form-control me-1" type="search" placeholder="جستجو براساس کلمه کلیدی" wire:model.live="search">
                    </div>
                ...
                <div class="col-12">
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-sm-6 col-lg-4 col-xl-3">
                            <a href="{{route('courses.detaile',$course->slug)}}">
                                <div class="card shadow h-100">
                                    <!-- Image -->
                                    <img src="{{asset($course->file)}}" class="card-img-top" alt="course image">
                                    <!-- Card body -->
                                    <div class="card-body pb-0">
                                        ...
                                        <button wire:click='addCart({{$course->id}})' >اضافه به سبد</button>
                                    </div>
                                    <!-- Card footer -->
